package com.shit.babsayeev2.navigation.Utils;
...
public class Common {
    ...
    public static void whichPermisionNotGranted(Context context, int[] grantResults) {
    ...
    public static String getDateFromTimeStamp(long timeStamp, String dateFormat) {
        @SuppressLint("SimpleDateFormat") DateFormat objFormatter = new SimpleDateFormat(dateFormat);
